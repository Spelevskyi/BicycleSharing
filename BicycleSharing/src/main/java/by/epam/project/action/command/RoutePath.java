...
public enum RoutePath {
    ...
    INDEX_PAGE_PATH("/index.jsp"), USER_ACCOUNT_PAGE_PATH("/jsp/user/account.jsp"),
    ADMIN_ACCOUNT_PAGE_PATH("/jsp/admin/account.jsp"),
    ...
    REDIRECT_ADMIN_ACCOUNT("controller?command=Admin_account_page"),
    REDIRECT_USER_ACCOUNT("controller?command=User_account_page"),
    ...
    REDIRECT_USERS_PAGE("controller?command=Users");
