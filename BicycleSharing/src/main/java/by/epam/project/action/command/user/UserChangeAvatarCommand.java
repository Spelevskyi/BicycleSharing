...
public class UserChangeAvatarCommand implements ActionCommand {

    private static final Logger logger = LogManager.getLogger(UserChangeAvatarCommand.class);

    private Logic logic = new ChangeAvatarLogic();

    @Override
    public Router execute(HttpServletRequest request) {
        logger.info("Changing user avatar executing.");
