...
<head>
<style>
<%@include file="/css/user_navbar.css"%>
</style>
	...
	<nav class="navbar-inverse nav-upper">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><welcometag:hello role="${role}" name="${user.getFirstName()}" /> <b
						class="caret"></b></a>
