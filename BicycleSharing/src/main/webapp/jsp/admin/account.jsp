...
<c:set var="previous_path" value="controller?command=Admin_account_page" scope="session" />
			...
			<div class="col-sm-6">
				<div class="account">
					...
					<form id="formId" action="${pageContext.session.servletContext.contextPath}/controller" method="POST">
						<input type="hidden" value="User_change_avatar" name="command" /> <input type="hidden" name="ImagePath" id="ImagePathId" value="" />
					</form>
					<div class="form">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="padding: 35px 50px;">
					...
					<h4><span class="glyphicon glyphicon-pencil"></span>${update}</h4>
				</div>
				<div class="modal-body" style="padding: 40px 50px;">
					...
					<form name="form" method="POST" action="${pageContext.session.servletContext.contextPath}/controller">
						<input type="hidden" name="command" value="Admin_change_profile" /> <input type="hidden" name="id" value="${user.getId()}" />
